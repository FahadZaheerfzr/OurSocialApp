...
class AndroidContact implements Serializable {
        ...
        if (ContactsManager.getInstance().hasReadContactsAccess() && mChangesToCommit.size() > 0) {
            try {
                ContentResolver contentResolver =
                        Context.instance().getApplicationContext().getContentResolver();
                    ...
                    ContentProviderOperation.newUpdate(Data.CONTENT_URI)
                            ...
                            .withValue(
                                    ...
                                    CommonDataKinds.StructuredName
                                            .CONTENT_ITEM_TYPE)
                            .withValue(
                                    CommonDataKinds.StructuredName.GIVEN_NAME, fn)
                            .withValue(
                                    CommonDataKinds.StructuredName.FAMILY_NAME, ln)
                            .build());
        }
    }
    ...
    boolean isLinphoneAddressMimeEntryAlreadyExisting(String value) {
        ...
        ContentResolver resolver = Context.instance().getApplicationContext().getContentResolver();
        ...
        Cursor c =
                resolver.query(
                        ...
                        new String[] {
                            mAndroidRawId,
                                "vnd.android.cursor.item/vnd.org.linphone.provider",
                            value
                        },
                        null);
        if (c != null) {
                        ...
                        ContentProviderOperation.newUpdate(Data.CONTENT_URI)
                                ...
                                .withValue(
                                        ...
                                        CommonDataKinds.Organization
                                                .CONTENT_ITEM_TYPE)
                                .withValue(
                                        CommonDataKinds.Organization.COMPANY, org)
                                .build());
            } else {
                Log.i(
