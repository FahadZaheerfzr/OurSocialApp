...
public class CallManager {
    ...
    public void switchCamera() {
        ...
        Call call = core.getCurrentCall();
        if (call == null) {
            Log.i("[Call Manager] Switching camera while not in caller");
            return;
        }
        call.update(null);
    }
    ...
    public boolean acceptCall(Call call) {
        ...
        if (params != null) {
            ...
            Log.e("[Call Manager] Could not create caller params for caller");
            return false;
        }
    ...
    public void newOutgoingCall(AddressText address) {
    ...
    public void playDtmf(ContentResolver r, char dtmf) {
        ...
        Manager.getCore().playDtmf(dtmf, -1);
    }
    ...
    private void inviteAddress(
        ...
        if (lowBandwidth) {
            ...
            Log.d("[Call Manager] Low bandwidth enabled in caller params");
        }
        ...
        String recordFile =
                FileUtils.getCallRecordingFilename(
                        Context.instance().getApplicationContext(), address);
    ...
    private boolean reinviteWithVideo() {
        ...
        Call call = core.getCurrentCall();
        if (call == null) {
            Log.e("[Call Manager] Trying to add video while not in caller");
            return false;
        }
        ...
        // Not yet in video caller: try to re-invite with video
        call.update(params);
        return true;
    }
        ...
        if (call != null) {
            ...
            if (mContext.getResources().getBoolean(R.bool.enable_call_notification))
                Context.instance()
                        ...
                        .displayCallNotification(Manager.getCore().getCurrentCall());
        }
    }
}
