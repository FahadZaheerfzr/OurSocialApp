...
public class LinphoneGL2JNIViewOverlay extends org.linphone.mediastream.video.display.GL2JNIView
    ...
    public LinphoneGL2JNIViewOverlay(
                ...
                new AndroidVideoWindowImpl(
                        ...
                        new AndroidVideoWindowImpl.VideoWindowListener() {
                            public void onVideoRenderingSurfaceReady(
                                ...
                                Manager.getCore().setNativeVideoWindowId(vw);
                            }
    ...
    public LinphoneGL2JNIViewOverlay(android.content.Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LinphoneGL2JNIViewOverlay(android.content.Context context) {
        this(context, null);
    }
