 ...
 */
package com.nust.socialapp.linphone.contacts;
...
public class ContactsManager extends ContentObserver
        implements FriendListListener, Context.CoreStartedListener {
    ...
    public static ContactsManager getInstance() {
        return Context.instance().getContactsManager();
    }

    public ContactsManager(android.content.Context context) {
        ...
        if (Manager.getCore() != null) {
            mMagicSearch = Manager.getCore().createMagicSearch();
            mMagicSearch.setLimitedSearch(false); // Do not limit the number of results
        }

        Context.instance().addCoreStartedListener(this);
    }
    ...
    public void destroy() {
        ...
        Context.instance().removeCoreStartedListener(this);
    ...
    public boolean isLinphoneContactsPrefered() {
        ProxyConfig lpc = Manager.getCore().getDefaultProxyConfig();
        return lpc != null
    ...
    private void initializeSyncAccount() {
        AccountManager accountManager =
                (AccountManager) mContext.getSystemService(android.content.Context.ACCOUNT_SERVICE);

        Account[] accounts =
                accountManager.getAccountsByType("org.linphone.sync");
