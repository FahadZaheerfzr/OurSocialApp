...
import com.nust.socialapp.linphone.compatibility.CompatibilityScaleGestureDetector;
import com.nust.socialapp.linphone.compatibility.CompatibilityScaleGestureListener;
...
public class VideoZoomHelper extends GestureDetector.SimpleOnGestureListener
    ...
    public boolean onScale(CompatibilityScaleGestureDetector detector) {
        ...
        Call currentCall = Manager.getCore().getCurrentCall();
        if (currentCall != null) {
