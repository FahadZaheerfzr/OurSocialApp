...
import com.nust.socialapp.linphone.call.CallActivity;
...
import com.nust.socialapp.linphone.fragments.EmptyFragment;
import com.nust.socialapp.linphone.fragments.StatusBarFragment;
import com.nust.socialapp.linphone.menu.SideMenuFragment;
...
import com.nust.socialapp.linphone.settings.SettingsActivity;
...
public abstract class MainActivity extends LinphoneGenericActivity
                        ...
                        if (state == RegistrationState.Ok) {
                            ...
                            if (getResources().getBoolean(R.bool.use_phone_number_validation)) {
                                ...
                                if (authInfo != null
                                    ...
                                    Manager.getInstance().isAccountWithAlias();
                                }
                            }
    ...
    protected void onResume() {
        ...
        Context.instance().getNotificationManager().removeForegroundServiceNotificationIfPossible();
   ...
   //     findViewById(R.id.status_fragment).setVisibility(View.GONE);
    ...
    public void requestPermissionIfNotGranted(String permission) {
        if (!checkPermission(permission)) {
            ...
            KeyguardManager km =
                    (KeyguardManager) getSystemService(android.content.Context.KEYGUARD_SERVICE);
            boolean locked = km.inKeyguardRestrictedInputMode();
            if (!locked) {
                // This is to workaround an infinite loop of pause/start in Activity issue
                // if incoming caller ends while screen if off and locked
    ...
    public void onRequestPermissionsResult(
        ...
        for (int i = 0; i < permissions.length; i++) {
            ...
            if (permissions[i].equals(Manifest.permission.READ_CONTACTS)
                ...
                Manager.getInstance().enableDeviceRingtone(enableRingtone);
    ...
    public void goBackToCall() {
        ...
        Call[] calls = Manager.getCore().getCalls();
    ...
    public void newOutgoingCall(String to) {
        if (Manager.getCore().getCallsNb() > 0) {
            ...
            Manager.getCallManager().newOutgoingCall(to, null);
        }
    }
