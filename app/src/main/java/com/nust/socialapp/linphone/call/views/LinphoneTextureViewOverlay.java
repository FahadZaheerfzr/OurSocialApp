 ...
 */
package com.nust.socialapp.linphone.call.views;
...
public class LinphoneTextureViewOverlay extends RelativeLayout implements LinphoneOverlay {
    ...
    public LinphoneTextureViewOverlay(
            android.content.Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        mWindowManager =
        ...
        LayoutParams localPreviewParams =
                new LayoutParams(localPreviewWidth, localPreviewHeight);
        ...
        setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(context, CallInterfaceActivity.class);
    ...
    public LinphoneTextureViewOverlay(android.content.Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LinphoneTextureViewOverlay(android.content.Context context) {
        this(context, null);
    }
