...
import com.nust.socialapp.linphone.receivers.BluetoothReceiver;
import com.nust.socialapp.linphone.receivers.HeadsetReceiver;
...
public class AndroidAudioManager {
    ...
    public AndroidAudioManager(android.content.Context context) {
        mContext = context;
        mAudioManager =
                ((AudioManager) context.getSystemService(android.content.Context.AUDIO_SERVICE));
        mVibrator = (Vibrator) context.getSystemService(android.content.Context.VIBRATOR_SERVICE);
                    ...
                    public void onCallStateChanged(
                        ...
                        if (state == Call.State.Connected) {
                            if (core.getCallsNb() == 1) {
                                ...
                                // However, incoming caller first use the MODE_RINGING to play the
                                // local ring.
                                ...
                                // Only register this one when a caller is active
                            ...
                            if (core.getCallsNb() == 0) {
                                ...
                                if (tm.getCallState() == TelephonyManager.CALL_STATE_IDLE) {
                                    ...
                                    Log.d(
                                            "[Audio Manager] All caller terminated, routing back to earpiece");
                                    routeAudioToEarPiece();
                                }
                            }
                        }
    ...
    private synchronized void startRinging(Address remoteAddress) {
        ...
        try {
            ...
            Log.e(e, "[Audio Manager] Cannot handle incoming caller");
        }
        mIsRinging = true;
    }
    ...
    public synchronized void bluetoothHeadetConnectionChanged(boolean connected) {
        ...
        if (Context.isReady()) Manager.getCallManager().refreshInCallActions();
    }
    ...
    private void startBluetooth() {
        ...
        if (mBluetoothAdapter != null) {
            ...
            if (mAudioManager.isBluetoothScoAvailableOffCall()) {
                Log.i("[Audio Manager] [Bluetooth] SCO available off caller, continue");
            } else {
                Log.w("[Audio Manager] [Bluetooth] SCO not available off caller !");
            }
