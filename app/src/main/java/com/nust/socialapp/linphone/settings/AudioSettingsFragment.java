 ...
 */
package com.nust.socialapp.linphone.settings;
...
import com.nust.socialapp.linphone.settings.widget.BasicSetting;
import com.nust.socialapp.linphone.settings.widget.ListSetting;
import com.nust.socialapp.linphone.settings.widget.SettingListenerBase;
import com.nust.socialapp.linphone.settings.widget.SwitchSetting;
import com.nust.socialapp.linphone.settings.widget.TextSetting;
...
public class AudioSettingsFragment extends SettingsFragment {
                        ...
                        int recordAudio =
                                getActivity()
                                        ...
                                        .checkPermission(
                                                ...
                                                getActivity().getPackageName());
                        if (recordAudio == PackageManager.PERMISSION_GRANTED) {
                            if (Manager.getAudioManager().getEchoTesterStatus()) {
                                stopEchoTester();
                            } else {
                                startEchoTester();
                            }
    ...
    private void startEchoTester() {
        Manager.getAudioManager().startEchoTester();
        mEchoTester.setSubtitle("Is running");
    }

    private void stopEchoTester() {
        Manager.getAudioManager().stopEchoTester();
        mEchoTester.setSubtitle("Is stopped");
    }

    private void startEchoCancellerCalibration() {
        if (Manager.getAudioManager().getEchoTesterStatus()) stopEchoTester();
        Manager.getCore()
                .addListener(
