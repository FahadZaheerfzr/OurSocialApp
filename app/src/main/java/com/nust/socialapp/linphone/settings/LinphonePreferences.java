...
public class LinphonePreferences {
    ...
    private String getString(int key) {
        if (mContext == null && Context.isReady()) {
            mContext = Context.instance().getApplicationContext();
        }
    ...
    public void setTunnelHost(String host) {
        ...
        if (config != null) {
            config.setHost(host);
            Manager.getInstance().initTunnelFromConf();
        }
    }
    ...
    public String getActivityToLaunchOnIncomingReceived() {
        if (getConfig() == null) return "org.linphone.caller.CallIncomingActivity";
        return getConfig()
                .getString(
                        "app", "incoming_call_activity", "org.linphone.caller.CallIncomingActivity");
    }
    ...
    public void enableDeviceRingtone(boolean enable) {
        ...
        Manager.getInstance().enableDeviceRingtone(enable);
    }
    ...
    public String getDeviceName(android.content.Context context) {
