...
import com.nust.socialapp.BuildConfig;

import com.nust.socialapp.R;
import com.nust.socialapp.linphone.assistant.PhoneAccountLinkingAssistantActivity;
import com.nust.socialapp.linphone.call.AndroidAudioManager;
import com.nust.socialapp.linphone.call.CallManager;
...
import com.nust.socialapp.linphone.utils.MediaScanner;
import com.nust.socialapp.linphone.utils.PushNotificationUtils;

/** Handles Linphone's Core lifecycle */
public class Manager implements SensorEventListener {
    ...
    public Manager(android.content.Context c) {
        mExited = false;
        mContext = c;
        ...
        mPowerManager = (PowerManager) c.getSystemService(android.content.Context.POWER_SERVICE);
        mConnectivityManager =
                (ConnectivityManager)
                        c.getSystemService(android.content.Context.CONNECTIVITY_SERVICE);
        mSensorManager = (SensorManager) c.getSystemService(android.content.Context.SENSOR_SERVICE);
        mProximity = mSensorManager.getDefaultSensor(Sensor.TYPE_PROXIMITY);
        mTelephonyManager =
                (TelephonyManager) c.getSystemService(android.content.Context.TELEPHONY_SERVICE);
        mPhoneStateListener =
                ...
                new CoreListenerStub() {
                    ...
                    public void onCallStateChanged(
                        ...
                        if ((state == State.IncomingReceived || state == State.IncomingEarlyMedia)
                            ...
                            // If the correspondent proposes video while audio caller
    ...
    public static synchronized Manager getInstance() {
        Manager manager = Context.instance().getLinphoneManager();
        if (manager == null) {
    ...
    public static synchronized Core getCore() {
        ...
        if (getInstance().mExited) {
            ...
            // Ex: stop caller and quickly terminate application.
            return null;
        }
    ...
    public synchronized void destroy() {
        ...
        // Otherwise some objects might crash during their own destroy if they try to caller
    ...
    public synchronized void startLibLinphone(boolean isPush, CoreListener listener) {
        try {
            ...
            /*use schedule instead of scheduleAtFixedRate to avoid iterate from being caller in burst after cpu wake up*/
