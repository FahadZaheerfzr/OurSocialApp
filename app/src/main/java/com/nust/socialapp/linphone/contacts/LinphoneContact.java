...
public class LinphoneContact extends AndroidContact
    ...
    */
    ...
    private void createFriend() {
        LinphoneContact contact = new LinphoneContact();
        Friend friend = Manager.getCore().createFriend();
    ...
    private synchronized void syncValuesFromAndroidContact(android.content.Context context) {
        Cursor c = null;
        try {
            c =
    ...
    public void save() {
        ...
        syncValuesFromAndroidContact(Context.instance().getApplicationContext());
        createOrUpdateFriend();
    }
