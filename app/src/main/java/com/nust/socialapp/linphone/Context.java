...
public class Context {
                ...
                new CoreListenerStub() {
                    ...
                    public void onCallStateChanged(
                        ...
                        if (state == Call.State.IncomingReceived
                            ...
                            // caller incoming notification
                            if (Version.sdkStrictlyBelow(Version.API24_NOUGAT_70)) {
                                if (!mManager.getCallGsmON()) {
                                   // mContext.startActivity(new Intent(mContext, CallInterfaceActivity.class));
                                }
                            }
    ...
    public void start(boolean isPush) {
        ...
        mManager.startLibLinphone(isPush, mListener);
    ...
    public void destroy() {
        ...
        // Destroy the LinphoneManager second to last to ensure any getCore() caller will work
        if (mManager != null) {
            mManager.destroy();
        }
    ...
    public Manager getLinphoneManager() {
        return mManager;
    }
