 ...
 */
package com.nust.socialapp.linphone.receivers;
        ...
        if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
            ...
            switch (state) {
                ...
                case BluetoothAdapter.STATE_ON:
                    ...
                    Manager.getAudioManager().bluetoothAdapterStateChanged();
                    break;
            ...
            if (state == BluetoothHeadset.STATE_CONNECTED) {
                ...
                Manager.getAudioManager().bluetoothHeadetConnectionChanged(true);
            } else if (state == BluetoothHeadset.STATE_DISCONNECTED) {
                Log.i("[Bluetooth] Bluetooth headset disconnected");
                Manager.getAudioManager().bluetoothHeadetConnectionChanged(false);
            } else {
            ...
            if (state == BluetoothHeadset.STATE_AUDIO_CONNECTED) {
                ...
                Manager.getAudioManager().bluetoothHeadetAudioConnectionChanged(true);
            } else if (state == BluetoothHeadset.STATE_AUDIO_DISCONNECTED) {
                Log.i("[Bluetooth] Bluetooth headset audio disconnected");
                Manager.getAudioManager().bluetoothHeadetAudioConnectionChanged(false);
            ...
            if (state == AudioManager.SCO_AUDIO_STATE_CONNECTED) {
                ...
                Manager.getAudioManager().bluetoothHeadetScoConnectionChanged(true);
            } else if (state == AudioManager.SCO_AUDIO_STATE_DISCONNECTED) {
                Log.i("[Bluetooth] Bluetooth headset SCO disconnected");
                Manager.getAudioManager().bluetoothHeadetScoConnectionChanged(false);
