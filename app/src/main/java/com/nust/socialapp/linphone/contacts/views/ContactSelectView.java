 ...
 */
package com.nust.socialapp.linphone.contacts.views;
...
import com.nust.socialapp.linphone.contacts.ContactAddress;
...
public class ContactSelectView extends View {
    ...
    public void setContactName(ContactAddress ca) {
        if (ca.getContact() != null) {
            ...
            Manager.getCore().createFriendWithAddress(ca.getAddressAsDisplayableString()).getName();
