 ...
 */
package com.nust.socialapp.linphone.service;
...
import com.nust.socialapp.linphone.call.views.LinphoneGL2JNIViewOverlay;
import com.nust.socialapp.linphone.call.views.LinphoneOverlay;
import com.nust.socialapp.linphone.call.views.LinphoneTextureViewOverlay;
...
public final class LinphoneService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (LinphonePreferences.instance().getServiceNotificationVisibility()
            ...
            // We need to caller this asap after the Service can be accessed through it's singleton
            Context.instance().getNotificationManager().startForeground();
        }

        if (misLinphoneContextOwned) {
            Context.instance().start(isPush);
        } else {
            Context.instance().updateContext(this);
        }
