...
import com.nust.socialapp.adapters.PostsAdapter;
import com.nust.socialapp.evet_page;
import com.nust.socialapp.linphone.assistant.GenericConnectionAssistantActivity;
import com.nust.socialapp.linphone.assistant.MenuAssistantActivity;
import com.nust.socialapp.main.base.BaseActivity;
import com.nust.socialapp.main.followPosts.FollowingPostsActivity;
import com.nust.socialapp.main.post.createPost.CreatePostActivity;
import com.nust.socialapp.main.postDetails.PostDetailsActivity;
import com.nust.socialapp.main.profile.ProfileActivity;
import com.nust.socialapp.main.search.SearchActivity;
import com.nust.socialapp.model.Post;
import com.nust.socialapp.utils.AnimationUtils;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.followingPosts:
                ...
                return true;
            case R.id.EventPosts:
                Intent EventPosts = new Intent(this, evet_page.class);
                startActivity(EventPosts);
                return true;

            case R.id.call:
                startActivity(new Intent(this, GenericConnectionAssistantActivity.class));
                return true;
            case R.id.search:
